...
import com.log.demo.model.OperationLog;
...
public class LogAspect {
     ...
     */
    @Pointcut("@annotation(com.log.demo.anotation.OperationLogDetail)")
    ...
    private void addOperationLog(JoinPoint joinPoint, Object res, long time){
        ...
        System.out.println("方法传入的参数为:"+joinPoint.getArgs()[0].toString());
